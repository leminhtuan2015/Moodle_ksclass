        ...
        <?php if($sectionLecture->parent_id == $sectionChapter->id){ ?>
            <div>
                <h4 class="panel-title">
                    <div class="active_link_lecture textOverflow" style="padding:16px;cursor: pointer;">
                        ...
                        <?php if ($cm->section == $sectionLecture->id) { ?>
                            <?php if($cm->module == ClientUtil::$resourceTypeQuiz){?>
                                ...
                                <?php if($quiz->type == ClientUtil::$typeTest){ ?>
                                    <div style="padding:10px;color:white;margin-left:25px;cursor: pointer;" class="active_link_lecture_test textOverflow">
