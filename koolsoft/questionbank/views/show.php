 ...
 */
?>
<script src="resources/javascript/questionbank.js"></script>
...
<?php echo \html_writer::select($catmenu, 'category', $cat, array(), array('class' => 'searchoptions custom-select', 'id' => 'id_selectacategory')); ?>
<br>
